document.addEventListener("DOMContentLoaded", function () {
    ...
    if (!explainBtn || !textArea || !outputDiv || !weightsDiv || !probabilityChartCanvas) {
    ...
    explainBtn.addEventListener("click", async () => {
      ...
      try {
        ...
        if (data.word_weights && data.word_weights.length > 0) {
    ...
    function updateProbabilityChart(probabilities) {
      if (!probabilities || !probabilityChartCanvas) return;
